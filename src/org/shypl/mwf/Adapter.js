function initMouseWheelFix() {
	/**
	 * @namespace doc.onmousewheel
	 * @namespace event.wheelDeltaY
	 * @namespace event.wheelDeltaX
	 * @namespace event.deltaX
	 * @namespace event.deltaY
	 * @namespace event.HORIZONTAL_AXIS
	 * @namespace swf.shk_mwf_handleWheel
	 */
